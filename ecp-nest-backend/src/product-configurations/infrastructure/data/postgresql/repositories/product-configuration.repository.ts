...
import { IProductConfigurationsRepository } from 'src/product-configurations/domain/abstracts/repositories/product-configuration.repository';
import { Repository } from 'typeorm';

export class ProductConfigurationsPostgresRepository<TData>
  extends PostgresGenericRepository<TData>
  implements IProductConfigurationsRepository<TData>
{
  constructor(
